<?php
  ...
  $options_panel->addCode('cseven_customizer_version_link', array('name'=> __('version 1.02','apc'), 'std'=> '<h4 class="wpcf7-form-linkk"><a rel="dofollow" href="http://alborotado.com/ayuda-wp/"> Ayuda Wordpress - Alborotado.com</a></h4>', 'desc' => __('')));
  $options_panel->CloseTab();